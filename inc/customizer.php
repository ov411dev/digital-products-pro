...
add_action('customize_register',function($wp_customize){
 $wp_customize->add_section('dpp_content',['title'=>__('Landing Page Content','digital-products-pro-full'),'priority'=>30]);
 $fields=[
 ...
 foreach($fields as $key=>$default){
  ...
  $wp_customize->add_control($key,['label'=>ucwords(str_replace(['dpp_','_'],['',' '],$key)),'section'=>'dpp_content','type'=>'text']);
 }
 $wp_customize->add_setting('dpp_dark_mode_default',['default'=>false,'sanitize_callback'=>'wp_validate_boolean']);
 $wp_customize->add_control('dpp_dark_mode_default',['label'=>__('Use dark mode by default','digital-products-pro-full'),'section'=>'dpp_content','type'=>'checkbox']);
});
